...
class BranchesControllerTest < ActionController::TestCase
  ...
  test "should create branch" do
    assert_difference('Branch.count') do
      post :create, branch: { description: @branch.description, image: @branch.image, name: @branch.name, neighborhood_id: @branch.neighborhood_id, slug: @branch.slug }
    end
  ...
  test "should update branch" do
    put :update, id: @branch, branch: { description: @branch.description, image: @branch.image, name: @branch.name, neighborhood_id: @branch.neighborhood_id, slug: @branch.slug }
    assert_redirected_to branch_path(assigns(:branch))
  end
